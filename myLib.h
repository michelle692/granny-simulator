...
// Custom Colors
#define BEIGE COLOR(31,25,17)
#define LIGHTBLUE COLOR(21,21,31)
#define DARKBLUE COLOR(11,11,16)
#define TEAL COLOR(12,16,21)
#define ORANGE COLOR(31,6,1)
#define GRAY1 COLOR(29,29,29)
#define GRAY2 COLOR(26,26,26)
#define GRAY3 COLOR(19,20,20)
