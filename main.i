...
# 1 "winScreenR.h" 1
# 21 "winScreenR.h"
extern const unsigned short winScreenRBitmap[19200];


extern const unsigned short winScreenRPal[256];
# 8 "main.c" 2
# 1 "loseScreenR.h" 1
# 21 "loseScreenR.h"
extern const unsigned short loseScreenRBitmap[19200];


extern const unsigned short loseScreenRPal[256];
# 9 "main.c" 2
# 1 "pauseScreen.h" 1
# 21 "pauseScreen.h"
...
# 1 "dentures.h" 1
# 21 "dentures.h"
extern const unsigned short denturesBitmap[392];


extern const unsigned short denturesPal[256];
# 11 "main.c" 2
...
void game() {
    ...
    DMANow(3, denturesPal, ((unsigned short *)0x5000000), 512 / 2);
...
void goToWin() {
    DMANow(3, winScreenRPal, ((unsigned short *)0x5000000), 256);
...
void goToLose() {
    ...
    DMANow(3, loseScreenRPal, ((unsigned short *)0x5000000), 256);
