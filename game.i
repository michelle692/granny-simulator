...
extern TESLA teslas[6];
extern TESLA teslasOpp[6];
...
enum {BLACKID=(256-10), BEIGEID, LIGHTBLUEID, DARKBLUEID, TEALID, ORANGEID, GRAY1ID, GRAY2ID, GRAY3ID, WHITEID, GRAYID};
...
# 1 "granny.h" 1
# 21 "granny.h"
extern const unsigned short grannyBitmap[392];


extern const unsigned short grannyPal[256];
# 6 "game.c" 2
# 1 "teslaDown.h" 1
# 21 "teslaDown.h"
extern const unsigned short teslaDownBitmap[392];


extern const unsigned short teslaDownPal[256];
# 7 "game.c" 2
# 1 "teslaUp.h" 1
# 21 "teslaUp.h"
extern const unsigned short teslaUpBitmap[392];


extern const unsigned short teslaUpPal[256];
# 8 "game.c" 2
# 1 "time.h" 1
# 21 "time.h"
extern const unsigned short timeBitmap[392];


extern const unsigned short timePal[256];
# 9 "game.c" 2
# 1 "heart.h" 1
# 21 "heart.h"
extern const unsigned short heartBitmap[392];


extern const unsigned short heartPal[256];
# 10 "game.c" 2
...
void initGame() {
 ...
 unsigned short colors[10] = {((31) | (25)<<5 | (17)<<10), ((21) | (21)<<5 | (31)<<10), ((11) | (11)<<5 | (16)<<10), ((12) | (16)<<5 | (21)<<10), ((31) | (6)<<5 | (1)<<10), ((29) | (29)<<5 | (29)<<10), ((26) | (26)<<5 | (26)<<10), ((19) | (20)<<5 | (20)<<10), ((31) | (31)<<5 | (31)<<10), ((15) | (15)<<5 | (15)<<10)};


 DMANow(3, grannyPal, ((unsigned short *)0x5000000), 512 / 2);
...
void updateGranny() {
 ...
 if ((~((*(volatile unsigned short *)0x04000130)) & ((1<<5))) && granny.col >= granny.cdel) {
  granny.col -= granny.cdel;
 }
 else if ((~((*(volatile unsigned short *)0x04000130)) & ((1<<4))) && granny.col + granny.width - 1 < 240 - granny.cdel) {
  granny.col += granny.cdel;
 }
 else if ((~((*(volatile unsigned short *)0x04000130)) & ((1<<6))) && granny.row >= granny.cdel) {
  granny.row -= granny.cdel;
 }
 else if ((~((*(volatile unsigned short *)0x04000130)) & ((1<<7))) && granny.row + granny.height - 1 < 160 - granny.cdel) {
  granny.row += granny.cdel;
 }
